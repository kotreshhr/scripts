...
echo 'y' | gluster vol create master replica 2 `hostname`:/bricks/brick0/b0 `hostname`:/bricks/brick0/b1 `hostname`:/bricks/brick0/b2 `hostname`:/bricks/brick0/b3 force
gluster vol start master
sleep 1
echo 'y' | gluster vol create slave replica 2 `hostname`:/bricks/brick1/b0 `hostname`:/bricks/brick1/b1 `hostname`:/bricks/brick1/b2 `hostname`:/bricks/brick1/b3 force
gluster vol start slave
sleep 1
echo 'y' | gluster vol create gluster_shared_storage replica 3 `hostname`:/bricks/brick3/b00 `hostname`:/bricks/brick3/b01 `hostname`:/bricks/brick3/b02 force
