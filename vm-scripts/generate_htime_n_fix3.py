...
htime_dir = os.path.abspath(os.path.join(htime_file_org, os.pardir))
htime_file=os.path.join(htime_dir, "HTIME.GEN")
...
os.rename(htime_file_org, new_htime_file_org)

print "Fixing HTIME, renaming %s to %s" % (htime_file, htime_file_org)
os.rename(htime_file, htime_file_org)

print "Successfully generated HTIME file"
